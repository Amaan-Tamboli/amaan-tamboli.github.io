...
// Get all qualification buttons and content sections
...
qualificationButtons.forEach((button) => {
  button.addEventListener('click', () => {
    ...
    qualificationButtons.forEach((btn) => btn.classList.remove('qualification__active'))
    qualificationContents.forEach((content) => content.classList.remove('qualification__active'))
